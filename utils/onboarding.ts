 ...
 * truth; this just avoids a network round trip on every launch once the answer
 * is already known. Keyed per account id so a second account signing in on the
 * same device can't inherit or clobber another account's state.
 */
